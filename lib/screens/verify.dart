...
class _VerifyState extends State<Verify> {
  ...
  Widget build(BuildContext context) {
    ...
    return FirebaseAuth.instance.currentUser!.isAnonymous == true ? const HomeScreen() : Scaffold(
        body: Container(
      ...
      child: ListView(
        ...
        children: [
          ...
          Align(
            ...
            child:
                Text(style: textStyle, "you need to verify email to continue"),
          ),
          box(0, 30),
          Align(
            alignment: Alignment.center,
          ...
          Align(
            ...
            child: ElevatedButton(
                ...
                child: Padding(
                    ...
                    child: loading ? const CircularProgressIndicator() : Text(style: textStyle, "Send Verfication Mail"),),),
          ),
        ],
      ),
    ));
